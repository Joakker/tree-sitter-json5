...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 31:
      ...
      END_STATE();
    case 32:
      if (sym_string_character_set_1(lookahead)) ADVANCE(5);
      if (lookahead == '\r') ADVANCE(1);
      if (lookahead == 'u') ADVANCE(41);
      if (lookahead == 'x') ADVANCE(37);
      END_STATE();
    case 33:
      if (sym_string_character_set_1(lookahead)) ADVANCE(6);
    ...
    case 51:
      ...
      if (sym_identifier_character_set_3(lookahead)) ADVANCE(69);
      END_STATE();
    case 52:
      ACCEPT_TOKEN(sym_identifier);
